# Date:14/08/2021
# Creating a RailwayApplication

class RailwayApplication():     #definig the class
    def PrintData(self):        #definig a method by function
...
uditsapplication.Date="14th august"
uditsapplication.PrintData()
